...
from lsdb.dask.merge_catalog_functions import (
    ...
    get_healpix_pixels_from_alignment, apply_suffixes,
)
from lsdb.types import DaskDFPixelMap

from lsdb_custom_graphs.lsdb import HealpixDataset
from lsdb_custom_graphs.lsdb.ops.lsdb_ops import AlignAndApply
...
def generate_meta_df_for_joined_tables(
    ...
    left_meta, right_meta = apply_suffixes(
        catalogs[0].operation.meta,
        catalogs[1].operation.meta,
        suffixes,
        suffix_method,
    ...
    if index_type is None:
        index_type = catalogs[0].operation.meta.index.dtype
...
def crossmatch_catalog_data(
    ...
    return joined_partitions, alignment
